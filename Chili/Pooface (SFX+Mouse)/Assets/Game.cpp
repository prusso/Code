	...
	gameIsOver( false )
{
	...
	{
		pooX[ index ] = (float)(rand() % (800 - 24));
		pooY[ index ] = (float)(rand() % (600 - 24));
	...
	tinkle = audio.CreateSound( "tinkle.wav" );
}
...
void Game::UpdateFace()
{
	...
	if( mouse.IsInWindow() && mouse.LeftIsPressed() )
	{
		...
		else if( mouse.GetMouseX() < faceX + 10 )
		{
			if( abs( faceX + 10 - mouse.GetMouseX() ) < speed )
			{
				faceX = mouse.GetMouseX() - 10;
		...
		if( mouse.GetMouseY() > faceY + 10 )
		{
			if( abs( faceY + 10 - mouse.GetMouseY() ) < speed )
			{
				faceY = mouse.GetMouseY() - 10;
			}
			else
			{
				faceY += speed;
		...
		else if( mouse.GetMouseY() < faceY + 10 )
		{
			if( abs( faceY + 10 - mouse.GetMouseY() ) < speed )
			{
				faceY = mouse.GetMouseY() - 10;
...
void Game::ComposeFrame()
{
	...
	for( int index = 0; index < nPoo; index++ )
	{
		DrawPoo( (int)pooX[ index ],(int)pooY[ index ] );
	}
