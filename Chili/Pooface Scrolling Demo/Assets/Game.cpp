	...
	cameraY( 0 )
{
	...
	{
		pooX[ index ] = (float)(rand() % (WORLDWIDTH - 24));
		pooY[ index ] = (float)(rand() % (WORLDHEIGHT - 24));
...
void Game::UpdatePoo()
{
	...
	for( int index = 0; index < nPoo; index++ )
	{
		...
		else if( pooX[ index ] + 24 > (WORLDWIDTH-1) )
		{			
			pooX[ index ] = (WORLDWIDTH-1) - 24;
			pooXVelocity[ index ] = -pooXVelocity[ index ];
		}
		...
		else if( pooY[ index ] + 24 > (WORLDHEIGHT-1) )
		{			
			pooY[ index ] = (WORLDHEIGHT-1) - 24;
			pooYVelocity[ index ] = -pooYVelocity[ index ];
		}
...
void Game::ComposeFrame()
{
	...
	for( int index = 0; index < nPoo; index++ )
	{
		...
		int poosx = (int)pooX[ index ] - cameraX;
		int poosy = (int)pooY[ index ] - cameraY;
